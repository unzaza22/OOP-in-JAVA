...
public class Main {
	public static void main(String[] args) {
		...
		System.out.println("go forward: " + robot1.goForwardN(5));
		System.out.println("\nRobot 2: ID=" + robot2.getID() + ", Name=" + robot2.getName() + ", Version=" + robot2.getVersion());
		System.out.println("go left: " + robot2.goLeftN(10));
		System.out.println("go backward: " + robot2.goBackwardN(3));
		System.out.println("\nRobot 3: ID=" + robot3.getID() + ", Name=" + robot3.getName() + ", Version=" + robot3.getVersion());
		System.out.println("go right: " + robot3.goRightN(8));
